...
function updateGauges(number) {
    for (var key in gauges) {
        // var number = Math.random() * 100;
        var theNumber = Math.round(number);
        if (theNumber < bad) {
            gauges[key].drawBand(0, theNumber, "#E04644");
        } else if (bad < number && theNumber < good) {
            gauges[key].drawBand(0, theNumber, "#FDE47F");
        } else {
...
function Gauge(placeholderName, configuration) {
    ...
    this.configure = function(configuration) {
        ...
        this.config.yellowColor = configuration.yellowColor || "#FDE47F";
        this.config.redColor = configuration.redColor || "#E04644";
    ...
    this.redraw = function(value, transitionDuration) {
        ...
        //     display = 'Loyal'
        // }
        // pointerContainer.selectAll("text").text(display);
      ...
      'time_spend_company': $('#time_spend_company').val(),
       ...
       'medium':0
        ...
        $.post({
          ...
          success: result => get_success(result),
